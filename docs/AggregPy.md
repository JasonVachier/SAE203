...
```python
    ...
    def charge_urls(liste_url):
        ...
        for url in liste_url:
            ...
            #todo Initialisation d'exeptions pour certains cas
    ...
    #todo      - On éffectue un trie 'sorted', en prenant dabors la date, puis sa catégorie. 
    #todo      - "Reverse" pour trié du plus récent au plus vieux 
    ...
    #todo      - On éffectue un trie 'sorted', en prenant dabors sa criticité, puis sa date. 
    ...
    def genere_html(liste_evenements, chemin_html):
        ...
        with open(chemin_html, 'w', encoding='utf-8') as fichier_html:
            ...
            fichier_html.write("""<!DOCTYPE html>
                        ...
                        <body>
                            <h1>Logs des Évenement</h1>\n\n""")                                 

            #* Implémentation des éléments souhaité dans la page html
            for evenement in liste_evenements:
                #todo Boucle afin de déterminé la coucleur en fonction de la criticité, et crée un bloc pour chaque évenement
                couleur = ""
    ...
    def main():
        ...
        #//rss_name = config['rss-name']                    #? récupère le nom du flux rss
        ...
        genere_html(tri, destination)                       #? génére la page html à partir du flux fusionné et trié vers la destination de la config ("destination")
